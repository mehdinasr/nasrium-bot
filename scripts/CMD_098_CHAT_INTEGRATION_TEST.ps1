...
# File ID   : CMD_098_001
# Module    : Chat
# Component : Chat System Integration Test
# Version   : 1.0.0
# Status    : Production
# ================================================================================
...
function Invoke-ChatIntegrationTest {
    ...
    Write-Host "Command   : CMD_098" -ForegroundColor Yellow
    Write-Host "=========================================" -ForegroundColor Cyan
    ...
    try {
        ...
        [System.IO.File]::WriteAllText((Join-Path $RegistryPath "CMD_098_001_state.json"), $state, [System.Text.Encoding]::UTF8)
...
if (Get-Command Invoke-NasriumCommand -ErrorAction SilentlyContinue) {
    Invoke-NasriumCommand -CmdId "CMD_098" -Action { Invoke-ChatIntegrationTest }
} else {
