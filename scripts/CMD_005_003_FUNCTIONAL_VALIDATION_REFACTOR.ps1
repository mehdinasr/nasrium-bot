...
# File ID   : CMD_005_003
# Module    : Governance
# Component : Functional Validation Refactor
# Version   : 1.0.0
# Status    : Production
# ================================================================================
...
Write-Host "UPGRADING VALIDATOR TO FUNCTIONAL TEST" -ForegroundColor Cyan
Write-Host "Command : CMD_005_003" -ForegroundColor Yellow
Write-Host "=========================================" -ForegroundColor Cyan
...
$newValidator | Set-Content $ValidatorPath -Encoding UTF8

Write-Host "✅ Validator upgraded to Functional Validation." -ForegroundColor Green
Write-Host "CMD_005_003 COMPLETE"
