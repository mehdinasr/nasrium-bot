...
# Component : Switch to InlineKeyboard for reliable WebApp launch
# Version   : 1.0.0
# Status    : Production
# ================================================================================
...
Write-Host "NASRIUM CMD_180 - INLINE WEBAPP BUTTON" -ForegroundColor Cyan
Write-Host "Command   : CMD_180" -ForegroundColor Yellow
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""

Set-Location "D:\Nasrium"

# Step 1: Update main.py with InlineKeyboardButton
Write-Host "[STEP 1] Updating main.py to use InlineKeyboard..." -ForegroundColor Cyan
$mainPy = @"
import os
import threading
...
Write-Host "[OK] main.py updated with InlineKeyboardButton" -ForegroundColor Green

# Step 2: Git Commit and Push
Write-Host ""
Write-Host "[STEP 2] Committing and pushing to GitHub..." -ForegroundColor Cyan
git add -A
git commit -m "CMD_180: Switch to InlineKeyboard for Mini App launch"
$branch = git branch --show-current
git push origin $branch --force

Write-Host ""
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "CMD_180_001 COMPLETE" -ForegroundColor Green
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "IMPORTANT: Make sure Domain in BotFather is set to:" -ForegroundColor Yellow
Write-Host "nasrium-bot-production.up.railway.app" -ForegroundColor Cyan
